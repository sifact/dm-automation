            ...
            {data.data.data.map((post: any) => (
              <div
                ...
                onClick={() =>
                  onSelectPost({
                    postid: post.id,
                    media: post.media_url || post.full_picture,
              ...
              >
                ...
                <div className="w-full h-full">
                  <img
                    ...
                    alt="post image"
                    className={cn("hover:opacity-75 transition duration-100 w-full h-full object-cover", posts.find((p) => p.postid === post.id) && "opacity-75")}
                  />
                </div>
              </div>
            ))}
